...
<head>
    ...
    <title>{{ _('403 - Accesso No Autorizado') }}</title>
</head>
...
<style>
    ...
    :root {
        ...
        --animation-sentence: 'Se supone que debes irte, ¿verdad?';
 ...
 */
    ...
    @keyframes showText {
        ...
        100% {
            --animation-sentence: 'Estas tardando mucho, muuuuucho tiempo...';
        }
    }
    ...
    @keyframes showNewText {
        ...
        100% {
            --animation-sentence: 'Vale, parece que te importa esto. Aquí hay una clave solo para ti';
        }
    }
...
<script>
    ...
    const grantAccess = () => {
        ...
        heading.textContent = '🎉Yei!! 🎉';
        paragraph.textContent = 'Acceso Concedido (Claro que no)';
